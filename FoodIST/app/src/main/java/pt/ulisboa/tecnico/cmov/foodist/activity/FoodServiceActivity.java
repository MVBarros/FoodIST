...
public class FoodServiceActivity extends BaseActivity implements OnMapReadyCallback {
    ...
    public void updateMenus() {
        ...
        new CancelableTask<>(new SafePostTask<>(new GetMenusTask(this))).executeOnExecutor(getGlobalStatus().getExecutor(), this.foodServiceId);
    }
    ...
    public void setHistogram(ArrayList<Menu> menus) {
