...
public class RemoveFromQueueTest {
    ...
    public void validTest() {
        ...
        Map<Integer, Mean> queueWaitTimes = impl.getService(SERVICE).getQueueWaitTimes();
        assertEquals(queueWaitTimes.size(), 1);
        assertTrue(queueWaitTimes.containsKey(0));
        assertEquals(queueWaitTimes.get(0).getCurrValue(), 0, DELTA);
    }
    ...
    public void validOneSecondIntervalTest() throws InterruptedException {
        ...
        assertEquals(queueWaitTimes.size(), 1);
        assertTrue(queueWaitTimes.containsKey(0));
        assertEquals(queueWaitTimes.get(0).getCurrValue(), 1, DELTA);
    }
    ...
    public void noSuchServiceTest() {
        ...
        assertEquals(queue.size(), 0);
        Map<Integer, Mean> queueWaitTimes = impl.getService(SERVICE2).getQueueWaitTimes();
        assertEquals(queueWaitTimes.size(), 0);
    }
}
